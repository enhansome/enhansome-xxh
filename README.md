...
[<img alt='[xxh demo]' src='https://raw.githubusercontent.com/xxh/static/master/xxh-demo2.gif'>](https://github.com/xxh/xxh#installation-methods) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
...
#### [Conda-forge](https://conda-forge.org/) [feedstock](https://github.com/conda-forge/xxh-xxh-feedstock) ⭐ 2 | 🐛 5 | 📅 2026-04-24
...
Currently supported OS for the target host is Linux on x86\_64. [ARM support](https://github.com/xxh/xxh/issues/188) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02 from the community.

| xxh-shell                                                                                                    | status | [xxh-plugins](https://github.com/xxh/xxh/wiki#plugins) ⭐ 6,074 \| 🐛 30 \| 🌐 Python \| 📅 2026-06-02                                                                                                                                                                                                                                                                                                               | [seamless](https://github.com/xxh/xxh/wiki#seamless-mode) ⭐ 6,074 \| 🐛 30 \| 🌐 Python \| 📅 2026-06-02 | demo                                                                                 |
| ------------------------------------------------------------------------------------------------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
...
| **[fish](https://github.com/xxh/xxh-shell-fish) ⭐ 22 \| 🐛 4 \| 🌐 Shell \| 📅 2022-12-21**                  | stable | [ohmyfish](https://github.com/xxh/xxh-plugin-fish-ohmyfish) ⭐ 4 \| 🐛 0 \| 🌐 Shell \| 📅 2020-10-05, [fisher](https://github.com/xxh/xxh-plugin-fish-fisher) ⭐ 10 \| 🐛 1 \| 🌐 Shell \| 📅 2021-03-08, [userconfig](https://github.com/xxh/xxh-plugin-fish-userconfig) ⭐ 3 \| 🐛 1 \| 🌐 Shell \| 📅 2020-07-27, [\[+\]](https://github.com/xxh/xxh-plugin-fish-example) ⭐ 4 \| 🐛 0 \| 🌐 Shell \| 📅 2020-07-27 | [todo](https://github.com/xxh/xxh/issues/74) ⭐ 6,074 \| 🐛 30 \| 🌐 Python \| 📅 2026-06-02              |                                                                                      |
...
| **[elvish](https://github.com/krageon/xxh-shell-elvish) ⭐ 4 \| 🐛 0 \| 🌐 Shell \| 📅 2021-06-23**           | alpha  |                                                                                                                                                                                                                                                                                                                                                                                                                     |                                                                                                          |                                                                                      |

[Search xxh shell on Github](https://github.com/search?q=xxh-shell\&type=Repositories) or [Bitbucket](https://bitbucket.org/repo/all?name=xxh-shell) or [create your shell entrypoint](https://github.com/xxh/xxh-shell-example) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2020-04-21 to use another portable shell.

### Prerun plugins

[Prerun plugins](https://github.com/xxh/xxh/wiki#plugins) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02 allow you to bring any portable tools, dotfiles, or aliases to your xxh session before running the shell.
...
For reusing arguments and simplifying xxh usage (like shortening to `xxh anyhost`), there is a [config file](https://github.com/xxh/xxh/wiki#config-file) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02.

**Why the plus sign for the xxh arguments?** The xxh is using the plus sign for xxh arguments to preserve the ability to use the minus sign for the original ssh arguments. This allows just replacing the first two letters in the `ssh` command to convert it to the `xxh` command. Also see the [discussion](https://github.com/xxh/xxh/issues/129) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02.
...
To run xxh inplace on Linux x86\_64 just copy and paste these bash commands:
...
Using [xxh-plugin-prerun-python](https://github.com/xxh/xxh-plugin-prerun-python) ⭐ 10 | 🐛 0 | 🌐 Shell | 📅 2022-04-27 you'll get a portable
...
Try [xxh-plugin-prerun-docker](https://github.com/xxh/xxh-plugin-prerun-docker) ⭐ 6 | 🐛 0 | 🌐 Shell | 📅 2020-05-20:
...
There is the [xxh-plugin-prerun-dotfiles](https://github.com/xxh/xxh-plugin-prerun-dotfiles) ⭐ 39 | 🐛 2 | 🌐 Shell | 📅 2024-04-29 plugin which creates config files
...
the [xxh-plugin-zsh-ohmyzsh](https://github.com/xxh/xxh-plugin-zsh-ohmyzsh) ⭐ 42 | 🐛 4 | 🌐 Shell | 📅 2021-03-29 and hack it.

### Read host as a table with [osquery](https://github.com/xxh/xxh-shell-osquery) ⭐ 7 | 🐛 1 | 🌐 Shell | 📅 2022-08-11
...
## [Questions and answers](https://github.com/xxh/xxh/wiki) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02

* [Welcome to xxh family](https://github.com/xxh/xxh/wiki#welcome-to-xxh-family) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [How it works](https://github.com/xxh/xxh/wiki#how-it-works) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
    * [Simple answer](https://github.com/xxh/xxh/wiki#simple-answer) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
    * [Detailed workflow with code](https://github.com/xxh/xxh/wiki#detailed-workflow-with-code) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Plugins](https://github.com/xxh/xxh/wiki#plugins) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Connection speed](https://github.com/xxh/xxh/wiki#connection-speed) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Seamless mode](https://github.com/xxh/xxh/wiki#seamless-mode) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Config file](https://github.com/xxh/xxh/wiki#config-file) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
* [Packages for xxh](https://github.com/xxh/xxh/wiki#packages-for-xxh) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Install shells and plugins](https://github.com/xxh/xxh/wiki#install-shells-and-plugins) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
* [Advanced](https://github.com/xxh/xxh/wiki#advanced) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [How to set /home/user as home on host](https://github.com/xxh/xxh/wiki#how-to-set-homeuser-as-home-on-host) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Using sudo](https://github.com/xxh/xxh/wiki#using-sudo) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Using xxh in xxh session](https://github.com/xxh/xxh/wiki#using-xxh-in-xxh-session) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Target host is behind another host](https://github.com/xxh/xxh/wiki#target-host-is-behind-another-host) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Environment variables](https://github.com/xxh/xxh/wiki#environment-variables) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
* [Development and contribution](https://github.com/xxh/xxh/wiki#development-and-contribution) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [The easiest way to debug shell and plugins](https://github.com/xxh/xxh/wiki#the-easiest-way-to-debug-shell-and-plugins) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Prerun plugins](https://github.com/xxh/xxh/wiki#prerun-plugins) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
  * [Change plugin run order](https://github.com/xxh/xxh/wiki#change-plugin-run-order) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02
* [New questions](https://github.com/xxh/xxh/wiki#new-questions) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02

## Development

### xxh Development Environment

In the [xxh development environment](https://github.com/xxh/xxh/tree/master/xde) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02 there is a full [dockerised](https://www.docker.com/) environment
...
newbie in another shell and mutual assistance is the key to xxh evolution. [Ask to join.](https://github.com/xxh/xxh/issues/50) ⭐ 6,074 | 🐛 30 | 🌐 Python | 📅 2026-06-02

## Thanks

* **Johannes Altmanninger** and **Fabian Homborg** for extensive and portable [fish shell](https://github.com/fish-shell/fish-shell) ⭐ 34,061 | 🐛 569 | 🌐 Rust | 📅 2026-08-25.
* **Anthony Scopatz**, **Gil Forsyth**, **Jamie Bliss**, **David Strobach**, **Morten Enemark Lund** and **@xore** for amazing [xonsh shell](https://github.com/xonsh/xonsh) ⭐ 9,619 | 🐛 73 | 🌐 Python | 📅 2026-08-25.
